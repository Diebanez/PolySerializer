...
namespace PolySerializer.Tests
{
    public class Deserialization
    {
        ...
        public void CharTest()
        {
            ...
            var targetOutput = new SupportClass<char>(
                'a',
                'b',
                new[] {'c', 'd', 'e'},
                new[] {'f', 'g', 'h', 'i', 'j'},
            ...
            var deserializedObject = (SupportClass<char>) deserializer.DeserializeFromString(input);
        ...
        public void StringTest()
        {
            ...
            var targetOutput = new SupportClass<string>(
                "aA",
                "bB",
                new[] {"cC", "dD", "eE"},
                new[] {"fF", "gG", "hH", "iI", "jJ"},
            ...
            var deserializedObject = (SupportClass<string>) deserializer.DeserializeFromString(input);
